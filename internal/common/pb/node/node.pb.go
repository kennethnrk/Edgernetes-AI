...
const file_api_proto_node_proto_rawDesc = "" +
	...
	"\alatency\x18\x04 \x01(\x03R\alatency\"\x87\x01\n" +
	"\fNodeMetadata\x12\x17\n" +
	"\aos_type\x18\x01 \x01(\tR\x06osType\x12\x1d\n" +
	"\n" +
	"os_version\x18\x02 \x01(\tR\tosVersion\x12#\n" +
	"\ragent_version\x18\x03 \x01(\tR\fagentVersion\x12\x1a\n" +
	"\bhostname\x18\x04 \x01(\tR\bhostname\"\xb3\x02\n" +
	"\bNodeInfo\x12\x17\n" +
	...
	"\tListNodes\x12\x15.nodeRegistryAPI.None\x1a\".nodeRegistryAPI.ListNodesResponseB0Z.internal/control-plane/api/grpc/pb/node;nodepbb\x06proto3"
